...
final class HttpRequestUtil {
    ...
    static String extractToken(HttpRequest httpRequest) {
        ...
        return Optional.ofNullable(httpRequest.getAuthorizationHeader())
                ...
                .orElseThrow(() -> new MalformedAuthorizationHeaderException(String.format("Malformed token [%s], No valid Authorization Header found", httpRequest.getAuthorizationHeader())));
    }
